...
function StepCreative() {
  ...
  // CTAs agora são automáticos via portfolio (TikTok Smart+ seleciona)
    ...
    <div className="card animate-fade-in">
      ...
      <div className="pt-5 border-t border-hawk-border">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="text-xs text-hawk-text/50 mt-1">CTAs: automático (TikTok Smart+ seleciona os melhores)</div>
        </div>
...
function StepLaunch() {
  ...
  async function launch() {
    ...
    // CTAs automáticos via portfolio
    ...
    try {
      const payload = {
        ...
        ad_texts: adTexts,
        // CTAs via portfolio automático (sem call_to_action_list)
        budget: budget,
